    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <p className="text-2xl font-bold text-red-600">£{financialSummary.totalSpending.toFixed(2)}</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center gap-2 mb-2">
            <Target className="h-5 w-5 text-blue-600" />
            <p className="text-gray-600 text-sm">Allocated to Goals</p>
          </div>
          <p className="text-2xl font-bold text-blue-600">£{financialSummary.totalAllocated.toFixed(2)}</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center gap-2 mb-2">
          ...
          <p className={`text-2xl font-bold ${financialSummary.availableFunds >= 0 ? 'text-purple-600' : 'text-red-600'}`}>
            £{financialSummary.availableFunds.toFixed(2)}
          </p>
        </div>
      </div>
